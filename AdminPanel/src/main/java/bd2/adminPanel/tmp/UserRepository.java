...
public class UserRepository {
    ...
    public UserRepository() {
        ...
        users.add(new User("kowal", "Jan", "Kowalski", "jan.kowalski@mail.com", "111-111-111", rightUser1));
        users.add(new User("kris", "Krzysztof", "Nowak", "krzysztof.nowak@mail.com", "222-222-222", rightUser2));
        users.add(new User("toja", "Tomasz", "Jaworek", "tomasz.jaworek@mail.com", "333-333-333", rightUser3));
    }
}
